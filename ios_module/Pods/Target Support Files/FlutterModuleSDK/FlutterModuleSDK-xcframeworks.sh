...
install_xcframework "${PODS_ROOT}/FlutterModuleSDK/App.xcframework" "App" "framework" "ios-x86_64-simulator" "ios-arm64_armv7"
install_xcframework "${PODS_ROOT}/FlutterModuleSDK/FlutterPluginRegistrant.xcframework" "FlutterPluginRegistrant" "framework" "ios-arm64_armv7" "ios-x86_64-simulator"
install_xcframework "${PODS_ROOT}/FlutterModuleSDK/flutter_boost.xcframework" "flutter_boost" "framework" "ios-arm64_armv7" "ios-x86_64-simulator"
